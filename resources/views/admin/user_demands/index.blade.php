...
<div class="pcoded-content">
    ...
    <div class="card">
        <div class="card-block">
            <form action="{{url('/import-user-demands')}}" method="post" enctype="multipart/form-data" id="import_user_demands" class="dropzone">
                @csrf
                <div>
                </div>
            </form> 
...
<script type="text/javascript">
    ...
    let newarr = []
    var dropzone = new Dropzone('#import_user_demands', {
        thumbnailWidth: 200,
        timeout: 18000000,
    ...
    function delete_user_demands(id) {
        var result = confirm("Want to delete?");
        if (result) {
            $.ajax({
                type:"POST",
                dataType:"json",
                url: "{{url('/delete-user-Demands')}}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    "data":  {id},
                },
